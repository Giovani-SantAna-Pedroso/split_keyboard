...
def maybe_make_abnt2_key(candidate: str) -> Optional[Key]:
    codes = (
        # Ç key (same as semicolon in HID)
        (51, ('CCEDILLA', 'C_CEDILLA', 'Ç')),

        # Tilde / circumflex key
        (0x34, ('TILDE', 'TILD_BR', '~')),

        (53, ('CIRCUMFLEX', 'CIRC_BR', '^')),
        

        # ABNT2 extra key (<> | \)
        (100, ('NON_US_BACKSLASH', 'NUBS', 'PIPE_BR')),

        # Slash / question (ABNT2 position differs)
        (56, ('SLASH_BR', '/')),
    )
...
def maybe_make_more_ascii(candidate: str) -> Optional[Key]:
    codes = (
        ...
        # ABNT2 aliases added here 👇
       (0x38, ('SEMICOLON', 'SCOLON', 'SCLN', ';', 'Ç')),
        (53, ('QUOTE', 'QUOT', "'", 'APOSTROPHE')),
        (47, ('GRAVE', 'GRV', '`')),
